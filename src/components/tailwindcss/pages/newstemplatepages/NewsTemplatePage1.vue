<template>
  ...
  <div class="relative bg-white md:border-2 mb-5">
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="hidden sm:flex justify-between items-center border-b-2 border-gray-100 py-4 md:space-x-10">
        <nav class="hidden md:flex space-x-4">
          <a href="#"
             class="text-xs leading-6 font-regular text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Sat,
            13 Jan</a>
          <a href="#"
             class="text-xs leading-6 font-regular text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">(+93)
            749 99 65 50</a>
        </nav>
      ...
      <div class="hidden sm:flex justify-center my-6">
      ...
      <div class="flex justify-center items-center py-5">
        <nav class="hidden md:flex space-x-4">
          <a href="#"
             class="text-sm leading-6 font-semibold text-gray-900 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">News</a>
          <a href="#"
             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Trend</a>
          <a href="#"
             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Report</a>
          <a href="#"
             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Story</a>
          <a href="#"
             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Women</a>
          <a href="#"
             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Opinion</a>
          <a href="#"
             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Interviews</a>
          <a href="#"
             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Multimedia</a>
          <a href="#"
             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Art
            & Culture</a> <a href="#"
                             class="text-sm leading-6 font-medium text-gray-500 focus:outline-none hover:text-indigo-900 transition ease-in-out duration-150">Sport</a>
      ...
      -->
      <div class="p-2 transition transform origin-top-right md:hidden">
        <div class="rounded-lg shadow-lg">
          <div class="rounded-lg shadow-xs bg-white divide-y-2 divide-gray-50">
            <div class="pt-5 pb-6 px-5 space-y-6">
              <div class="flex items-center justify-between">
                <div>
                  <a href="https://componentity.com" target="_blank" class="flex">
                    <img
  ...
  <!-- Component Code from (event hero section pure TailwindCSS 4th) -->

  <div class="max-w-screen-xl mx-auto my-5 sm:my-10 p-5 sm:p-0">
    <div class="grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2 gap-5">
      ...
      <div class="relative w-full flex items-end justify-start text-left bg-cover bg-center"
        ...
        <main class="p-5 z-10">
          <a href="#" class="text-md tracking-tight font-medium leading-7 font-regular text-white hover:underline">Dr.
      ...
      <div class="relative w-full flex items-end justify-start text-left bg-cover bg-center"
        ...
        <main class="p-5 z-10">
          <a href="#" class="text-md tracking-tight font-medium leading-7 font-regular text-white hover:underline">Afghanistan's
      ...
      <div class="relative w-full flex items-end justify-start text-left bg-cover bg-center"
        ...
        <main class="p-5 z-10">
          <a href="#" class="text-md tracking-tight font-medium leading-7 font-regular text-white hover:underline">Middle
      ...
      <div class="relative w-full flex items-end justify-start text-left bg-cover bg-center"
        ...
        <main class="p-5 z-10">
          <a href="#" class="text-md tracking-tight font-medium leading-7 font-regular text-white hover:underline">Afghan
  ...
  <img class="mx-auto block w-screen-md mt-5 p-5 sm:p-0"
       src="https://i2.wp.com/kabulnow.af/wp-content/uploads/2020/04/LeaksWebsiteBannerEnglish-1.gif?w=850&ssl=1"/>
  <div class="bg-gray-100 my-20 py-20 px-10 sm:px-16">
    <div class="max-w-screen-xl mx-auto relative">
      ...
      <g>
        ...
        <path d="M53.527,192.864c-2.187,3.518-1.109,8.142,2.409,10.329l183.478,114.081c1.232,0.767,2.601,1.132,3.953,1.132
          ...
          <a href="#" class="font-semibold inline-block">Sport News</a>
        </div>
        <a href="#">See All</a>
      </div>
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div class="flex flex-col justify-between border-b pb-5">
          <a href="#" class="text-gray-900 font-medium hover:text-indigo-600">Cristiano Ronaldo of Juventus FC looks
            dejected during the...</a>
          <div class="flex items-start justify-between mt-3">
            ...
            <a href="#" class="inline-block ml-2">
              <div class="w-20 h-20 bg-cover bg-center"
                   style="background-image:url(https://media.gettyimages.com/photos/cristiano-ronaldo-of-juventus-fc-looks-dejected-during-the-uefa-of-picture-id1227967060?k=6&m=1227967060&s=612x612&w=0&h=cMSMlRyI6YAzcE_C2KgHGRLeVojHYoUhIvhwPBYv8f4=);"></div>
            </a>
          </div>

        </div>
        <div class="flex flex-col justify-between border-b pb-5">
          <a href="#" class="text-gray-900 font-medium hover:text-indigo-600">Bests of Leonel Messi (Videos, Images &
            Quotes)</a>
          <div class="flex items-start justify-between mt-3">
            <div class="text-sm w-2/3">
              <p class="text-gray-700">Cristiano Ronaldo of Juventus FC looks dejected during the...</p>
            ...
            <a href="#" class="inline-block ml-2">
              <div class="w-20 h-20 bg-cover bg-center"
                   style="background-image:url(https://media.gettyimages.com/photos/lionel-messi-and-marcandre-ter-stegen-of-fc-barcelona-waits-in-the-picture-id1266763488?k=6&m=1266763488&s=612x612&w=0&h=8vxz9HfQVfrff5N7d1lBVxtLamRQGK3J3lyHkUuuIiw=);"></div>
            </a>
          </div>
        ...
        <div class="flex flex-col justify-between border-b pb-5">
          ...
          <div class="flex items-start justify-between mt-3">
            ...
            <a href="#" class="inline-block ml-2">
              <div class="w-20 h-20 bg-cover bg-center"
                   style="background-image:url(https://media.gettyimages.com/photos/cristiano-ronaldo-of-juventus-reacts-during-the-uefa-champions-league-picture-id1264546157?k=6&m=1264546157&s=612x612&w=0&h=LlY_gF4hYuRI68Btvq0tK0FcZDNIsJyEyaLaZV2Hi-M=);"></div>
            </a>
          </div>
        ...
        <div class="flex flex-col justify-between pb-5">
          <a href="#" class="text-gray-900 font-medium hover:text-indigo-600">Juventus v Olympique Lyon Best Ronaldo
            Images</a>
          <div class="flex items-start justify-between mt-3">
            <div class="text-sm w-2/3">
              <p class="text-gray-700">Cristiano Ronaldo of Juventus FC looks dejected during the...</p>
  ...
  <div class="max-w-screen-xl mx-auto relative p-5 sm:p-0">
    <div class="grid grid-cols-1 sm:grid-cols-12 gap-10">
      ...
      <div class="sm:col-span-6 lg:col-span-9">
        ...
        <div
            class="mt-3 text-center bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
          <div class="">
            <a href="#"
            ...
            <p class="text-gray-700 text-base mt-2 mx-5 sm:mx-10">Meet the Republican dissidents fighting to push Donald
              Trump out of office—and reclaim their party</p>
          </div>
        </div>
      </div>
  ...
  <img class="mx-auto block w-screen-md my-5 sm:mt-10 p-5 sm:p-0"
       src="https://i2.wp.com/kabulnow.af/wp-content/uploads/2020/04/LeaksWebsiteBannerEnglish-1.gif?w=850&ssl=1"/>
  <div class="max-w-screen-xl mx-auto relative my-5 sm:my-10 p-5 sm:p-0">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
      <div class="border p-5 py-10">
        <div class="border-b mb-5 flex justify-between text-sm">
          <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
            <svg class="h-6 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 455.005 455.005"
      ...
      <g>
        ...
        <div class="flex items-start border-b mb-3 pb-3">
          ...
          <div class="text-sm">
            <p class="text-gray-600 text-xs">Aug 18</p>
            <a href="#" class="text-gray-900 font-medium hover:text-indigo-600 leading-none">Cristiano Ronaldo of
              Juventus FC looks dejected during the...</a>
          </div>
        </div>
        <div class="flex items-start border-b mb-3 pb-3">
          <a href="#" class="inline-block mr-3">
        ...
        <div class="flex items-start">
          <a href="#" class="inline-block mr-3">
            <div class="w-20 h-20 bg-cover bg-center"
                 style="background-image:url(https://media.gettyimages.com/photos/lionel-messi-of-fc-barcelona-looks-dejected-following-his-teams-in-picture-id1266341828?k=6&m=1266341828&s=612x612&w=0&h=FZi-bSrIlOEE01780h79GsbBYPqZo2l3aaCxoktWADY=);"></div>
          </a>
          <div class="text-sm w-2/3">
            <p class="text-gray-600 text-xs">July 23</p>
            <a href="#" class="text-gray-900 font-medium hover:text-indigo-600 leading-none">Barcelona v Bayern Munich -
  ...
  <div class="max-w-screen-xl mx-auto relative">
    <div class="sm:flex items-start  p-5 sm:p-0 sm:-mx-10">
      ...
      <g>
        ...
        <div class="mb-5 pb-5 w-full lg:flex justify-center items-center border-b">
          <a href="#">
            <div
                class="h-56 lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden"
                style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
            </div>
          </a>
          <div
            ...
            <div class="">
              <a href="#"
                 class="text-sm text-indigo-600 uppercase font-medium mb-3 flex items-center hover:text-gray-900 transition duration-500 ease-in-out">
                Fashion
              </a>
              <a href="#"
                 class="text-gray-900 font-bold text-xl mb-2 hover:text-indigo-600 transition duration-500 ease-in-out">The
                perfect summer sweater that you can wear! </a>
...
<g>
    ...
    <path d="M40,26.5h1c2.2,0,4-1.8,4-4v-1c0-2.2-1.8-4-4-4h-1c-1.1,0-2-0.7-2-1.6V15c0-0.9,0.9-1.6,2-1.6h1c1.1,0,2,0.7,2,1.6v0.5h2
            ...
            <a href="#" class="font-semibold inline-block">Ad</a>
          </div>
        </div>
        <img class="w-100"
             src="https://images.pexels.com/photos/3684971/pexels-photo-3684971.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"/>
      </div>

    </div>
  </div>

  <div class="bg-gray-100 pt-5 mt-10">
