    ...
    <div class="grid grid-cols-1 md:grid-cols-12 border">
      <div class="bg-gray-900 md:col-span-4 p-10 text-white">
        ...
        <div class="flex items-center mt-5">
          <svg class="h-6 mr-2 text-indigo-600" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg"
               viewBox="0 0 489.536 489.536" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<!--https://codepen.io/componentity/pen/QWNgLxW-->
<script>
export default {
  name: "ContactFormPage4"
}
</script>
