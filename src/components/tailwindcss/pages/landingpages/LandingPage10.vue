<template>
  <div id="" class="antialiased h-screen bg-gray-100">
    ...
    <div class="lg:flex">
          ...
          <div v-show="isOpen" class="w-5/6 fixed bg-white h-screen z-20">
            <div class="pt-4 pb-2 px-4 flex items-center justify-between bg-gray-200">
              ...
              <div @click="toggleMenu">
                <svg class="w-10 h-10 fill-current text-red-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     width="24" height="24">
            ...
            <div class="flex flex-col items-start">
              <div class="pl-4 py-4 w-full flex items-center border-b border-gray-400">
                <svg class="w-6 h-6 fill-current text-green-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     width="24" height="24">
                  <path class="heroicon-ui"
      ...
      <transition name="mask">
        <div v-show="isOpen" class="fixed inset-0 h-screen w-screen bg-black opacity-75 lg:hidden"
      ...
      <div class="lg:flex lg:w-full">
        <div class="h-12 flex items-center justify-evenly bg-green-600 shadow-md lg:hidden">
          <div @click="toggleMenu" class="h-full flex items-center justify-center border-r border-green-700">
            <svg class="mx-2 w-8 h-8 fill-current text-green-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 width="24" height="24">
              <path class="heroicon-ui"
        ...
        <div class="hidden lg:flex lg:flex-col transition-menu w-20" :class="{ 'w-2/6': isOpen}">
          ...
          <nav v-show="!isOpen" class="h-screen bg-green-900 transition-menu">
            <div class="flex flex-col items-center px-2">
              <div class="pt-4 pb-2 px-4 flex items-center" @click="toggleMenu">
                <svg class="w-8 h-8 fill-current text-green-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     width="24" height="24">
                  <path class="heroicon-ui"
                        d="M4 5h16a1 1 0 0 1 0 2H4a1 1 0 1 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2z"/>
                </svg>
              ...
              <div class="py-4 mt-8 w-full flex flex-col items-center justify-center">
                <svg class="w-8 h-8 fill-current text-green-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                     width="24" height="24">
                  <path class="heroicon-ui"
                        d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zM5.68 7.1A7.96 7.96 0 0 0 4.06 11H5a1 1 0 0 1 0 2h-.94a7.95 7.95 0 0 0 1.32 3.5A9.96 9.96 0 0 1 11 14.05V9a1 1 0 0 1 2 0v5.05a9.96 9.96 0 0 1 5.62 2.45 7.95 7.95 0 0 0 1.32-3.5H19a1 1 0 0 1 0-2h.94a7.96 7.96 0 0 0-1.62-3.9l-.66.66a1 1 0 1 1-1.42-1.42l.67-.66A7.96 7.96 0 0 0 13 4.06V5a1 1 0 0 1-2 0v-.94c-1.46.18-2.8.76-3.9 1.62l.66.66a1 1 0 0 1-1.42 1.42l-.66-.67zM6.71 18a7.97 7.97 0 0 0 10.58 0 7.97 7.97 0 0 0-10.58 0z"/>
                </svg>
          ...
          <nav v-show="isOpen" class="h-screen bg-green-900 transition-menu">
            <div class="flex flex-col">
              <div class="pt-4 pb-2 px-4 flex items-center justify-between bg-green-200">
                <div class="text-xl font-semibold text-green-900">MENU</div>
                <div @click="toggleMenu">
                  <svg class="w-8 h-8 fill-current text-red-800" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                       width="24" height="24">
                    <path class="heroicon-ui"
                          d="M4.93 19.07A10 10 0 1 1 19.07 4.93 10 10 0 0 1 4.93 19.07zm1.41-1.41A8 8 0 1 0 17.66 6.34 8 8 0 0 0 6.34 17.66zM13.41 12l1.42 1.41a1 1 0 1 1-1.42 1.42L12 13.4l-1.41 1.42a1 1 0 1 1-1.42-1.42L10.6 12l-1.42-1.41a1 1 0 1 1 1.42-1.42L12 10.6l1.41-1.42a1 1 0 1 1 1.42 1.42L13.4 12z"/>
                  </svg>
              ...
              <div class="py-2 pb-4 flex flex-col items-center justify-center bg-green-200 border-b border-gray-400">
                <div class="w-16 h-16 flex items-center justify-center border-4 border-green-600 rounded-full">
                  <svg class="ml-2 w-12 h-12 fill-current text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none"
                       viewBox="0 0 83 86">
                    <defs/>
        ...
        <div class="w-full">
          <div class="mx-6 my-3 h-10 flex items-center justify-evenly border border-green-300 rounded-lg">
            <div class="h-full w-full flex items-center justify-center">
              <svg class="mx-2 w-8 h-8 fill-current text-green-300" xmlns="http://www.w3.org/2000/svg"
                   viewBox="0 0 24 24" width="24" height="24">
                <path class="heroicon-ui"
                      d="M16.32 14.9l5.39 5.4a1 1 0 0 1-1.42 1.4l-5.38-5.38a8 8 0 1 1 1.41-1.41zM10 16a6 6 0 1 0 0-12 6 6 0 0 0 0 12z"/>
              </svg>
              <input class="pb-1 h-full w-full rounded-lg bg-transparent focus:outline-none" type="text"
                     placeholder="Search">
            </div>
          </div>
          ...
          <div>
            ...
            <div class="lg:mx-6">
              <div class="md:flex md:justify-around">
                <div
                    class="mx-2 my-4 pb-1 flex flex-col justify-between bg-white shadow-lg border border-green-200 text-sm lg:w-full">
                ...
                <div
                    class="mx-2 mt-4 mb-4 pb-1 flex flex-col bg-white shadow-lg border border-green-200 text-sm lg:w-full">
                  ...
                  <div class="my-2 flex items-center justify-around">
                    <div class="mx-4 flex flex-col items-center">
                      <div>
                        <svg class="w-20 fill-current text-gray-600" xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 58 19">
                          <defs/>
                          <path fill-rule="evenodd"
                                d="M49.234 4.457l7.887-1.972-.242-.97-8.113 2.028L42.316 9H31.41l-11.957 4.484-8.505-1.501L.814 16.036l.372.928 9.867-3.947 8.495 1.5L31.59 10h11.092l6.551-5.543z"
                                clip-rule="evenodd"/>
                        </svg>
                      </div>
                      ...
                      <div>
                        <svg class="w-20 fill-current text-gray-600" xmlns="http://www.w3.org/2000/svg"
                          ...
                          <g clip-path="url(#clip0)">
                            <path fill-rule="evenodd"
                                  d="M56.864-.157l-8.193 8.705-7.048-1.51-9.027 7.021L20.57 10.05l-8.39 5.43-10.61 1.515-.14-.99 10.39-1.484 8.61-5.571 11.974 3.991 8.973-6.979 6.952 1.49 7.807-8.295.728.686z"
                                  clip-rule="evenodd"/>
                          </g>
                          <defs>
                            <clipPath id="clip0">
