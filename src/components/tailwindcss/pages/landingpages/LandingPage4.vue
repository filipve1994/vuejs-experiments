<template>
  ...
  <div class="max-w-4xl mx-4">
    ...
    <h2 class="pb-1 font-bold text-xl text-indigo-700 border-b border-indigo-600 mt-8">Advantages</h2>
  ...
  <div class="bg-gray-800 py-12 mt-12 w-full flex flex-col items-center border-t-2 border-black">
    ...
    <form class="max-w-xl w-full text-gray-200 mt-4 px-8 md:px-0" action="#" method="post">
      ...
      <div class="flex flex-col md:flex-row  md:-mx-2">
        ...
        <input class="bg-gray-700 mt-4 border border-gray-600 rounded-lg py-2 px-4 w-full md:mx-2" type="text" placeholder="something@somewhere.com" id="email">
      ...
      <div class="flex flex-col md:flex-row md:-mx-2">
        <button class="bg-blue-600 text-sm mt-4 py-2 px-4 w-full rounded-lg md:mx-2">Create Account</button>
      </div>
    </form>
  </div>
  </main>
