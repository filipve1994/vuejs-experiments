        ...
        <div class="flex flex-col flex-grow bg-white lg:shadow-2xl lg:rounded-lg lg:overflow-hidden">
          <div class="flex-grow flex flex-col justify-center p-12">
            ...
            <div class="md:pl-16 pl-0">
              <h1 class="sm:font-light text-2xl sm:text-3xl md:text-4xl text-gray-900 mt-6">
                I want to do The Impossible! <br>
                I wanna perform the impossible.</h1>
              <p class="sm:text-xl text-gray-600 mt-3 leading-relaxed">
             <span class="font-mono bg-gray-200 text-sm sm:text-base text-gray-700 subpixel-antialiased px-1 rounded">
They live inside of glassware; <br>
Medusaes live inside my glassware <br>
And they dance, and they dance and they dance <br>
Until the moonlight comes over their bodies.</span>
                <br>

              </p>

              <span
                  class="font-mono bg-indigo-100 text-sm sm:text-base text-gray-700 subpixel-antialiased px-1 py-1 rounded">christina_demeo</span>
            </div>
          </div>
              ...
              <div
                ...
                <div class="flex flex-grow">
                  ...
                  <div class="flex flex-col leading-relaxed ml-4 md:ml-6">
                    ...
                    <p class="text-gray-600 mt-1 text-sm md:text-base">Browse pre-built components using Tailwind’s
                      utility classes. </p>
                    <div class="pt-1 mt-auto">
                      <a class="inline-flex items-center text-teal-600 hover:text-teal-800"
              ...
              <div class="flex flex-col px-12 py-10 w-full sm:w-1/2 border-t-2 sm:border-r sm:border-t border-gray-200">
                <div class="flex flex-grow">
                  ...
                  <div class="flex flex-col leading-relaxed ml-4 md:ml-6">
                    ...
                    <p class="text-gray-600 mt-1 text-sm md:text-base">A collection of assets and resources to help
                      supercharge your Tailwind workflow.</p>
                    <div class="pt-1 mt-auto">
                      <a class="inline-flex items-center text-teal-600 hover:text-teal-800"
              ...
              <div class="flex flex-col px-12 py-10 w-full sm:w-1/2 border-t-2 sm:border-l sm:border-t border-gray-200">
                <div class="flex flex-grow">
                  ...
                  <div class="flex flex-col leading-relaxed ml-4 md:ml-6">
                    ...
                    <p class="text-gray-600 mt-1 text-sm md:text-base">Connect and learn from other Tailwind users in
                      the community.</p>
                    <div class="pt-1 mt-auto">
                      <a class="inline-flex items-center text-teal-600 hover:text-teal-800"
...
<!--https://codepen.io/diomed/pen/mYvPVG -->
<script>
export default {
  name: "LandingPage8"
}
