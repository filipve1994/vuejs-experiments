<template>
  ...
  <div class="relative">
    ...
    <div class="max-w-3xl mb-10 rounded overflow-hidden flex flex-col mx-auto text-center">
      <a href="#"
         class="max-w-3xl mx-auto text-xl sm:text-4xl font-semibold inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">The
...
<!--https://codepen.io/componentity/pen/abNWXjL-->
<script>
export default {
  name: "SingleBlogPage9"
}
</script>
