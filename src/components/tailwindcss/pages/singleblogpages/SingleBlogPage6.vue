<template>
  ...
  <div class="relative">
    ...
    <div class="max-w-screen-lg mx-auto my-10 px-10">
      ...
      <div class="text-gray-700 text-xs flex my-6 flex justify-between">
        <div class="flex items-center">
          <a href="#"><img class="w-12 h-12 rounded-full mr-2" src="https://tailwindcss.com/img/jonathan.jpg"
                           alt="Avatar of Jonathan Reinink"></a>
          <div class="text-sm">
            <a href="#"
               class="text-gray-900 font-medium leading-none hover:text-indigo-600 transition duration-500 ease-in-out">Jonathan
              Reinink</a>
        ...
        <div class="flex-row flex">
          <a href="/#" class="w-6 mx-1">
            <svg class="fill-current cursor-pointer hover:text-gray-500 text-indigo-600" width="100%" height="100%"
    ...
    <div class="max-w-screen-lg mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 relative px-10">
      <div class="lg:col-span-8">
        <div class="content">
          ...
          <p class="text-base leading-8 my-5">
            ...
            Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like
            Aldus PageMaker including versions of Lorem Ipsum.</p>
          <blockquote class="text-md italic leading-8 my-5 p-5 text-indigo-600 font-semibold">Lorem Ipsum is simply
      ...
      <div class="lg:col-span-4 lg:border-l lg:pl-5 ">
      ...
      <g>
        ...
        <path d="M53.527,192.864c-2.187,3.518-1.109,8.142,2.409,10.329l183.478,114.081c1.232,0.767,2.601,1.132,3.953,1.132
          ...
          C60.338,188.266,55.714,189.346,53.527,192.864z"/>
            ...
            <a href="#" class="font-semibold inline-block">Most Popular</a>
          </div>
        </div>
        <div class="my-4 flex">
        <span class="text-indigo-600 font-bold text-3xl mr-4">
          1.
        </span>
          <div class="text-md border-b pb-4">
            <a href="#" class="text-gray-900 hover:text-indigo-600 font-semibold">Special Yummy Pizza</a>
        ...
        <span class="text-indigo-600 font-bold text-3xl mr-4">
          ...
          <div class="text-md border-b pb-4">
            <a href="#" class="text-gray-900 hover:text-indigo-600 font-semibold">New Brunch Recipe</a>
            <p class="text-gray-500 text-sm">Lorem ipsum, dolor sit amet consectetur Lorem ipsum, dolor sit amet
              consectetur</p>
          </div>
        </div>
        <div class="my-4 flex">
        <span class="text-indigo-600 font-bold text-3xl mr-4">
          ...
          <div class="text-md border-b pb-4">
            <a href="#" class="text-gray-900 hover:text-indigo-600 font-semibold">The perfect summer sweater that you
              can wear! </a>
            <p class="text-gray-500 text-sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
...
<!--https://codepen.io/componentity/pen/gOrWZBo-->
<script>
export default {
  name: "SingleBlogPage6"
}
</script>
