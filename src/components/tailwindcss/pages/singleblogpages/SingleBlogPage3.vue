  ...
  <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="max-w-2xl mx-auto">
      <div class="mt-3 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
        <a href="#"><img class="rounded-full relative top-0 -mt-16 mx-auto h-24 w-24 rounded-full border-4"
                         src="https://tailwindcss.com/img/jonathan.jpg"></a>
        ...
        <div class="">
          ...
          <blockquote class="border-l-4 text-base italic leading-8 my-5 p-5 text-indigo-600">Lorem Ipsum is simply dummy
...
<!--https://codepen.io/componentity/pen/QWNvmwK-->
<script>
export default {
