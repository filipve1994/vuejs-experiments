<template>
  ...
  <div class="relative">
    ...
    <div class="relative h-screen w-full flex items-center justify-center text-center bg-cover bg-center"
         style="background-image:url(https://images.pexels.com/photos/5120892/pexels-photo-5120892.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=625.0&sharp=10&w=1500);">
      <div class="absolute top-0 right-0 bottom-0 left-0 bg-gray-900 opacity-75"></div>

      <main class="px-4 lg:px-8 z-10 sm:max-w-3xl sm:mx-auto">
        <div class="text-center">
          <h2 class="text-2xl tracking-tight leading-10 font-medium sm:text-3xl text-white md:text-4xl">
...
<!--https://codepen.io/componentity/pen/ZEWKwxp-->
<script>
export default {
  name: "SingleBlogPage8"
}
</script>
