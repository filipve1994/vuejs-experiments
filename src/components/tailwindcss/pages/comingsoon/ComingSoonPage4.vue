<template>
  ...
  <div id="comingsoonpage4" class="relative h-screen w-full flex items-center justify-center bg-cover bg-center text-center px-5"
    ...
    <div class="z-50 flex flex-col justify-center text-white w-full h-screen">
      ...
      <div class="mt-10 mb-5">
        <div class="shadow w-full bg-white mt-2 max-w-2xl mx-auto rounded-full">
          <div class="rounded-full bg-indigo-600 text-xs leading-none text-center text-white py-1" style="width: 75%">
            75%
          </div>
        </div>
      </div>
...
<!--https://codepen.io/componentity/pen/poyrjmr -->
<script>
export default {
  name: "ComingSoonPage4"
}
</script>
