<template>
  ...
  <div id="comingsoonpage3" class="relative h-screen w-full flex items-center justify-center bg-cover bg-center text-center px-5"
...
<!--https://codepen.io/componentity/pen/dyMzYVQ -->
<script>
export default {
  name: "ComingSoonPage3"
}
</script>
