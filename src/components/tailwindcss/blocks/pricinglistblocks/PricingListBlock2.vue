<template>
  <div class="py-24 max-w-screen-xl mx-auto">
    ...
    <div class="sm:grid grid-cols-2 col-gap-10">
      ...
      <div class="flex flex-row justify-between items-start my-8 sm:my-4">

        <div class="md:flex items-center">
          <img class="w-16 h-16 rounded-full mr-4"
               src="https://images.pexels.com/photos/208537/pexels-photo-208537.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
               alt="Special Yummy Pizza">
          <div class="text-md">
...
<!--https://codepen.io/componentity/pen/NWNNJbm-->
<script>
export default {
  name: "PricingListBlock2"
}
</script>
