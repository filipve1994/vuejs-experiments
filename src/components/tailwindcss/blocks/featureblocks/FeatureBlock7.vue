    ...
    <div
      ...
      <div class="">
        <div class="h-full mx-auto rounded bg-cover bg-right shadow-lg"
             style="min-height:450px; background-image:url(https://images.pexels.com/photos/1043473/pexels-photo-1043473.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500);"></div>
      </div>
...
<!--https://codepen.io/componentity/pen/QWNNYOB-->
<script>
export default {
  name: "FeatureBlock7"
}
