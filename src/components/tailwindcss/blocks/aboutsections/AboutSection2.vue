  ...
  <div class="sm:flex items-center max-w-screen-xl p-10 sm:p-16 md:p-24">
    <div class="sm:w-2/3 sm:mr-10">
      <div class="text">
        ...
        <h2 class="font-bold text-3xl my-4 sm:text-4xl">About <span class="text-indigo-600 font-bold">Our Company</span>
        </h2>
        <p class="text-gray-700">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, commodi doloremque,
          fugiat illum magni minus nisi nulla numquam obcaecati placeat quia, repellat tempore voluptatum.</p>
      </div>
    </div>
    <div class="sm:w-1/3 sm:mx-auto">
      <div class="image object-center text-center">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
             x="0px" y="0px" class="w-full" viewBox="0 0 512 512" enable-background="new 0 0 512 512"
             xml:space="preserve">  <image id="image0" class="" x="0" y="0" xlink:href="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAgAAAAIACAYAAAD0eNT6AAAABGdBTUEAALGPC/xhBQAAACBjSFJN
...
<!--https://codepen.io/componentity/pen/YzqGOQJ-->
<script>
export default {
  name: "AboutSection2"
}
