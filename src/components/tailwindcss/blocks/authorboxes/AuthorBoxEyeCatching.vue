<template>
  ...
  <!-- Component Code -->
  <div class="max-w-screen-sm rounded overflow-hidden mx-auto my-32">
    <div class="icons">
      <button class="bg-indigo-400 py-2 px-4 hover:bg-indigo-600 text-white">

        <svg height="20" width="24" class="inline-block text-white" viewBox="-42 0 512 512.002"
        ...
        <span class="inline-block ml-1 align-middle">Bio</span></button>

      <button class="bg-green-400 py-2 hover:bg-green-600 text-white px-4">
        <svg height="20" class="inline-block text-white" viewBox="-66 0 569 569.286" width="24"
             xmlns="http://www.w3.org/2000/svg">
          <path
          ...
          <path
              ...
              fill="#fff"/>
          <path d="m75.976562 189.667969h227.597657v18.964843h-227.597657zm0 0" fill="#fff"/>
          <path d="m75.976562 132.765625h75.867188v18.96875h-75.867188zm0 0" fill="#fff"/>
          <path d="m75.976562 246.566406h151.734376v18.96875h-151.734376zm0 0" fill="#fff"/>
          <path d="m246.675781 246.566406h56.898438v18.96875h-56.898438zm0 0" fill="#fff"/>
          <path d="m75.976562 303.464844h227.597657v18.96875h-227.597657zm0 0" fill="#fff"/>
          <path d="m75.976562 417.265625h227.597657v18.96875h-227.597657zm0 0" fill="#fff"/>
          <path d="m161.324219 360.367188h142.25v18.964843h-142.25zm0 0" fill="#fff"/>
          <path d="m75.976562 360.367188h66.382813v18.964843h-66.382813zm0 0" fill="#fff"/>
          <path d="m75.976562 474.167969h37.933594v18.964843h-37.933594zm0 0" fill="#fff"/>
          <path d="m132.875 474.167969h170.699219v18.964843h-170.699219zm0 0" fill="#fff"/>
        </svg>
        <span class="inline-block ml-1 align-middle">Latest Post</span></button>
    </div>
    <div class="flex border-black shadow-lg p-3 border-2">
      <div class="flex flex-col items-center justify-center lg:w-1/5 md:w-1/4 mr-4">
        <div class="image">
          <img class="w-40 mb-2" src="http://codenawis.com/wp-content/uploads/2020/08/images.jpg">
        </div>
...
<path style="fill:#3A559F;" d="M0,0v455.73h242.704V279.691h-59.33v-71.864h59.33v-60.353c0-43.893,35.582-79.475,79.475-79.475
	h62.025v64.622h-44.382c-13.947,0-25.254,11.307-25.254,25.254v49.953h68.521l-9.47,71.864h-59.051V455.73H455.73V0H0z"/>
          ...
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
               x="0px" y="0px"
               class="inline-block" viewBox="0 0 455.731 455.731" style="enable-background:new 0 0 455.731 455.731;"
  ...
  <path style="fill:#FFFFFF;" d="M60.377,337.822c30.33,19.236,66.308,30.368,104.875,30.368c108.349,0,196.18-87.841,196.18-196.18
		...
		c0,0,10.439,43.968,63.271,48.077c0,0-41.777,37.74-101.081,28.885L60.377,337.822z"/>
          ...
          <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
               ...
               width="35" height="35" class="inline-block">
<path style="fill:#DD4B39;" d="M0,0v455.73h455.73V0H0z M265.67,247.037c-7.793,51.194-45.961,80.543-95.376,80.543
	...
	v-35.218h-35.233v-25.041h35.233v-35.233h25.026v35.233h35.233V234.517z"/>
      ...
      <div class="lg:w-4/5 md:w-3/4 ">
        ...
        <p class="my-2 text-base">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad consequuntur eius ex,
          fugiat inventore labore laborum magni, maiores nihil provident quos vitae.</p>
      </div>
    </div>
  </div>
...
<!--https://codepen.io/componentity/pen/bGpGgqY-->
<script>
export default {
  name: "AuthorBoxEyeCatching"
}
</script>
