  ...
  <div class="max-w-sm rounded overflow-hidden shadow-lg">
    ...
    <div class="pt-3 pb-5 px-5 flex flex-col items-center">
      ...
      <div class="flex flex-row align-center justify-center">
        <a href="#">
          <svg class="ml-2" height="20px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
          <g>
            <g>
...
<!--https://codepen.io/componentity/pen/NWNKLOW-->
<script>
export default {
  name: "AuthorBoxGradient"
}
</script>
