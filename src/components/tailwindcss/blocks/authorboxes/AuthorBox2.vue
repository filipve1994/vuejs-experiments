    ...
    <div class="max-w-screen-md mx-auto">
      ...
      <div class="p-5">
        ...
        <div class="sm:flex items-center">
          <img class="w-48 h-48 h-full sm:mr-10" src="http://codenawis.com/wp-content/uploads/2020/08/images.jpg" alt="Avatar of Jonathan Reinink">
          <div class="text-left">
...
<!--https://codepen.io/componentity/pen/OJNgpwz-->
<script>
export default {
name: "AuthorBox2"
}
