  ...
  <div class="py-24 bg-white">
    <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        <p class="mt-4 text-sm leading-7 text-gray-50 font-regular">
          SERVICES
        </p>
      ...
      <div class="mt-16 text-center">
        <ul class="md:grid md:grid-cols-3 md:col-gap-32 md:row-gap-10">
          <li>
...
<!--https://codepen.io/componentity/pen/OJNNVMx-->
<script>
export default {
  name: "ServicesBlock2"
}
