  ...
  <div class="flex justify-center items-center min-h-screen bg-gray-50 p-4">
    <div class="flex flex-col rounded shadow-xl max-w-sm">
      <div class="flex-shrink-0">
        <img class="h-48 w-full object-cover" src="https://images.unsplash.com/photo-1588453905571-300bb8aa0ffd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=900&q=60" alt="Person hiking in the woods" />
      </div>
      <div class="flex-1 bg-white p-6 flex flex-col justify-between">
        ...
        <div class="mt-6 flex items-center">
          <div class="flex-shrink-0">
            <a href="#">
              <img class="h-10 w-10 rounded-full object-cover" src="https://images.unsplash.com/photo-1528892952291-009c663ce843?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=100&q=40" alt="" />
            </a>
          </div>
          <div class="ml-3">
...
<!--https://codepen.io/vincenttt/pen/PoPOQdy-->
<script>
export default {
  name: "CardBlock9"
}
