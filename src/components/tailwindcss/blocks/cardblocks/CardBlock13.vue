  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrao mx-auto my-32 lg:my-0">
    ...
    <div id="profile"
      ...
      <div class="p-4 md:p-12 text-center lg:text-left">
        ...
        <p class="pt-6 text-sm">🖐 Shabby chic irure nulla mlkshk do sustainable. Selfies trust fund umami, flannel
          consectetur fashion axe cillum craft beer poutine.</p>
    ...
    <div class="w-full lg:w-2/5">
      ...
      <img src="https://source.unsplash.com/WMD64tMfc4k" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block"
