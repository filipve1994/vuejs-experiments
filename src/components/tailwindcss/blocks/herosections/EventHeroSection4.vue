<template>
  ...
  <div class="relative h-screen w-full flex flex-col sm:flex-row items-center justify-center sm:justify-start text-center sm:text-left bg-cover bg-center" style="background-image:url(https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80);">
    ...
    <div class="flex sm:flex-col z-10">
      ...
      <div class="text-sm font-light flex items-center m-5">
        <svg width="35px" fill="white" class="mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<!--https://codepen.io/componentity/pen/MWyKREG-->
<script>
export default {
name: "EventHeroSection4"
}
</script>
