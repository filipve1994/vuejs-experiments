<template>
  ...
  <div class="relative py-24 w-full flex items-center justify-center text-center bg-cover bg-center" style="background-image:linear-gradient(to bottom right, gray, black)">
    ...
    <main class="px-4 sm:px-6 lg:px-8 z-10">
      <div class="text-center">
        ...
        <h2 class="text-3xl tracking-tight leading-10 font-extrabold sm:text-4xl text-white sm:leading-none md:text-5xl">
          Enter Your
          <span class="text-indigo-600">Headline</span>
        </h2>
        <div class="my-4 flex items-center justify-center">
          <a href="#">
            <svg class="mr-3" fill="white" width="22px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g data-name="Layer 2"><g data-name="facebook"><rect width="24" height="24" transform="rotate(180 12 12)" opacity="0"/><path d="M17 3.5a.5.5 0 0 0-.5-.5H14a4.77 4.77 0 0 0-5 4.5v2.7H6.5a.5.5 0 0 0-.5.5v2.6a.5.5 0 0 0 .5.5H9v6.7a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-6.7h2.62a.5.5 0 0 0 .49-.37l.72-2.6a.5.5 0 0 0-.48-.63H13V7.5a1 1 0 0 1 1-.9h2.5a.5.5 0 0 0 .5-.5z"/></g></g></svg></a>
          <a href="#"><svg class="mr-3" width="18px" fill="white" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g id="XMLID_826_">
	<path id="XMLID_827_" d="M302.973,57.388c-4.87,2.16-9.877,3.983-14.993,5.463c6.057-6.85,10.675-14.91,13.494-23.73
		...
		C307.394,57.037,305.009,56.486,302.973,57.388z"/>
          ...
          <a href="#"><svg width="21px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
