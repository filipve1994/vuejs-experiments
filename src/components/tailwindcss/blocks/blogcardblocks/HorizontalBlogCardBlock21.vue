    ...
    <div class="grid sm:grid-cols-2 gap-10">
      ...
      <g>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
          <div class="w-full">
            <a href="#"><div class="h-56 bg-cover text-center overflow-hidden" style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
            </div></a>
          ...
          <div class="lg:border-l lg:pl-4">
            <div class="text-md border-b pb-4 mb-4">
              <a href="#" class="text-gray-900 hover:text-indigo-600 font-semibold">These Two Friends Are Bringing Fabulous, Modest Style to TikTok</a>
              <p class="text-gray-500 text-xs">Lorem ipsum, dolor sit amet consectetur Lorem ipsum, dolor sit amet consectetur</p>
            </div>
            <div class="text-md border-b pb-4 mb-4">
              <a href="#" class="text-gray-900 hover:text-indigo-600 font-semibold">This Designer Is Making Crochet Lingerie for Men</a>
              <p class="text-gray-500 text-xs">Lorem ipsum, dolor sit amet consectetur Lorem ipsum, dolor sit amet consectetur</p>
            </div>
            <div class="text-md border-b pb-4 mb-4">
              <a href="#" class="text-gray-900 hover:text-indigo-600 font-semibold">These Baloch Sisters Shoot Hoops in Style</a>
              <p class="text-gray-500 text-xs">Lorem ipsum, dolor sit amet consectetur Lorem ipsum, dolor sit amet consectetur</p>
            </div>
            <div class="text-md pb-4">
              <a href="#" class="text-gray-900 hover:text-indigo-600 font-semibold">Is It Time To Invest In This Mask Accessory?</a>
              <p class="text-gray-500 text-xs">Lorem ipsum, dolor sit amet consectetur Lorem ipsum, dolor sit amet consectetur</p>
            </div>
...
<!--https://codepen.io/componentity/pen/JjXNWJY-->
<script>
export default {
name: "HorizontalBlogCardBlock21"
}
</script>
