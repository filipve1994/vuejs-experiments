    ...
    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
      ...
      <div class="relative w-full flex items-end justify-start text-left bg-cover bg-center"
        ...
        <div class="absolute right-0 bottom-0 left-0 p-5" style="background: rgba(0,0,0,.7);">
          <main class="z-10">
            <a href="#"
               class="text-md tracking-tight font-medium leading-7 font-regular text-white hover:underline text-opacity-100">Middle
...
<g>
	<g>
      ...
      <span class="ml-1">6 mins ago</span></span>
            <a href="#" class="flex flex-row items-center hover:underline  mr-3">
      ...
      <div class="relative w-full flex items-end justify-start text-left bg-cover bg-center"
        ...
        <div class="absolute right-0 bottom-0 left-0 p-5" style="background: rgba(0,0,0,.7);">
          <main class="z-10" style="opacity: 1;">
            <a href="#"
               class="text-md tracking-tight font-medium leading-7 font-regular text-white hover:underline text-opacity-100">Afghan
...
<g>
	<g>
      ...
      <div class="relative w-full flex items-end justify-start text-left bg-cover bg-center"
           style="height: 450px; background-image:url(https://media.gettyimages.com/photos/afghanistan-president-ashraf-ghani-carries-the-coffin-of-slain-picture-id1192749054?k=6&m=1192749054&s=612x612&w=0&h=CV-WfSEmfPOf3FdU934-JcUPkeCXOv7se-InwdewvPo=);">
        <div class="absolute right-0 bottom-0 left-0 p-5" style="background: rgba(0,0,0,.7);">
          <main class="z-10">
            <a href="#"
               class="text-md tracking-tight font-medium leading-7 font-regular text-white hover:underline text-opacity-100">Coffin
              Of Slain Japanese Doctor Nakamura Transported To Japan
            </a>
          </main>
          <div class="mt-5 text-sm font-regular text-white flex items-center justify-between">
      <span class="mr-3 flex flex-row items-center">
...
<!--https://codepen.io/componentity/pen/rNeWGZZ-->
<script>
export default {
  name: "BlogCardOverlayBlock13"
}
</script>
