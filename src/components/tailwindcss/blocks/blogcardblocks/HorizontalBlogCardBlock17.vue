    ...
    <div class="lg:flex">
        ...
        <div class="relative h-full w-full flex items-end justify-start text-left bg-cover bg-center"
          ...
          <main class="p-8 z-10">
            ...
            <p class="text-gray-200 text-xs">
              By <a href="#" class="text-white font-semibold hover:underline">Ahmad Sultani</a>&nbsp;&nbsp;|&nbsp;&nbsp;5
              mins read
            </p>
          </main>
      ...
      <div class="lg:w-6/12 md:grid grid-cols-2 grid-rows-2">
        ...
        <div class="relative w-full flex items-end justify-start text-left bg-cover bg-center"
          ...
          <main class="p-5 z-10">
            <a href="#" class="text-md tracking-tight font-medium leading-7 font-regular text-white hover:underline">Coffin
...
<!--https://codepen.io/componentity/pen/MWyJGXa-->
<script>
export default {
  name: "HorizontalBlogCardBlock17"
}
</script>
