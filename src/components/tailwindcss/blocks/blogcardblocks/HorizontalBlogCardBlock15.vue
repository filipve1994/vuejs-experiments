<template>
  ...
  <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16 relative">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
      ...
      <div class="flex items-start border p-2">
        ...
        <div class="text-sm w-2/3">
          <a href="#" class="text-gray-900 font-medium hover:text-indigo-600 leading-none">Cristiano Ronaldo of Juventus
      ...
      <div class="flex items-start border p-2">
        <a href="#" class="inline-block mr-2">
          <div class="w-20 h-20 bg-cover bg-center"
               style="background-image:url(https://media.gettyimages.com/photos/adrien-rabiot-of-juventus-speaks-with-cristiano-ronaldo-of-juventus-picture-id1264539015?k=6&m=1264539015&s=612x612&w=0&h=brdyoxRVlVgTXtkOJstPpuQIQe-jh6HkN2ZEZbvknKg=);"></div>
        </a>
        <div class="text-sm w-2/3">
          <a href="#" class="text-gray-900 font-medium hover:text-indigo-600 leading-none">Juventus v Olympique Lyon -
      ...
      <div class="flex items-start border p-2">
        <a href="#" class="inline-block mr-2">
          <div class="w-20 h-20 bg-cover bg-center"
               style="background-image:url(https://media.gettyimages.com/photos/lionel-messi-of-fc-barcelona-looks-dejected-during-the-uefa-champions-picture-id1266335724?k=6&m=1266335724&s=612x612&w=0&h=OyTJElOYowJlOiCg25MfiG6B-g2ctEjzDdvfCMF44mY=);"></div>
        </a>
        <div class="text-sm w-2/3">
