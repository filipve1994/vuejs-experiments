      ...
      <div class="sm:col-span-5">
        ...
        <div
          ...
          <div class="">
            ...
            <p class="text-gray-700 text-base mt-2">Meet the Republican dissidents fighting to push Donald Trump out of
              office—and reclaim their party</p>
          </div>
        </div>
      </div>
...
<!--https://codepen.io/componentity/pen/vYGmppm-->
<script>
export default {
  name: "BlogCardBlock27"
}
</script>
