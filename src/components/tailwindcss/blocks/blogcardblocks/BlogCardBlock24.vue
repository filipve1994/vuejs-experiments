<template>
  ...
  <!-- Component Code -->
  <div class="max-w-screen-xl mx-auto relative px-5 sm:px-10">
    <div class="grid grid-cols-1 sm:grid-cols-12 gap-10">

      <div class="lg:col-span-8 p-8 border">
        <div class="mb-5 pb-5 w-full lg:flex justify-center items-center">
          <a href="#"><div class="h-56 w-full sm:w-64 flex-none bg-cover overflow-hidden" style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
          </div></a>
          <div class="bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
            <div class="">
              <a href="#" class="text-sm text-indigo-600 uppercase font-medium mb-3 flex items-center hover:text-gray-900 transition duration-500 ease-in-out">
                Fashion
              </a>
              <a href="#" class="text-gray-900 font-bold text-md sm:text-xl mb-2 hover:text-indigo-600 transition duration-500 ease-in-out">The perfect summer sweater that you can wear! </a>
      ...
      <div class="lg:col-span-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-10">
