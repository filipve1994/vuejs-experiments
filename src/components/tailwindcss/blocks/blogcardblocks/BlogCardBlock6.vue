<template>
  ...
  <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
      ...
      <div class="rounded overflow-hidden shadow-lg flex flex-col border">
        <div class="flex items-center p-4">
          ...
          <div class="text-sm">
            ...
            <p class="text-gray-600 text-xs">Aug 18 | in <a href="#"
...
<!--https://codepen.io/componentity/pen/VwamWVW-->
<script>
export default {
  name: "BlogCardBlock6"
}
