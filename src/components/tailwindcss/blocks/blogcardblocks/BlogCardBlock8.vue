    ...
    <div class="rounded overflow-hidden flex flex-col max-w-2xl mx-auto border">
      <div class="sm:flex justify-between items-center pt-4 px-5">
        ...
        <div class="sm:w-4/12 flex items-center sm:px-6 pb-4">
          <a href="#"><img class="w-10 h-10 rounded-full mr-2" src="https://tailwindcss.com/img/jonathan.jpg"
      ...
      <span href="#" class="p-5 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
...
<!--https://codepen.io/componentity/pen/ExKNvjN-->
<script>
export default {
  name: "BlogCardBlock8"
}
