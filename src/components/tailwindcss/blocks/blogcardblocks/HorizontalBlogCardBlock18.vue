<template>
  <!-- Component Code -->
  <div class="max-w-screen-xl mx-auto relative md:p-10">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <g>
        ...
        <div class="mb-5 pb-5 w-full border-b">
          <a href="#"><div class="h-56 bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
          </div></a>
...
<!--https://codepen.io/componentity/pen/WNwRyeb-->
<script>
export default {
name: "HorizontalBlogCardBlock18"
}
</script>
