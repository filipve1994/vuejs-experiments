<template>
  ...
  <div class="max-w-screen-lg mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="mb-10 rounded overflow-hidden flex flex-col mx-auto text-center">
      <a href="#" class="max-w-3xl mx-auto text-xl sm:text-4xl font-semibold inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">The Best Activewear from the Nordstrom Anniversary Sale</a>
...
<!--https://codepen.io/componentity/pen/bGpBodE-->
<script>
export default {
name: "BlogCardBlock10"
}
</script>
