<template>
  ...
  <div class="max-w-screen-xl mx-auto relative">
    <div class="sm:flex items-start">
      ...
      <div class="md:w-8/12 sm:w-6/12 p-8">
      ...
      <g>
        ...
        <div class="mb-5 pb-5 w-full lg:flex justify-center items-center border-b">
          ...
          <div
            ...
            <div class="">
              ...
              <a href="#"
                 class="text-gray-900 font-bold text-md sm:text-xl mb-2 hover:text-indigo-600 transition duration-500 ease-in-out">The
                perfect summer sweater that you can wear! </a>
              <p class="text-gray-700 text-xs sm:text-base mt-2">Lorem ipsum dolor sit amet, consectetur adipisicing
                elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.</p>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-5">
          ...
          <div class="rounded overflow-hidden flex flex-col">
            ...
            <a href="#"
               class="text-sm inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block p-2">Simplest
              Salad Recipe ever</a>
          </div>
          <div class="rounded overflow-hidden flex flex-col">
            <a href="#">
      ...
      <div class="sticky top-0 md:w-4/12 sm:w-6/12 p-8 sm:border-l">
        <div class="border-b mb-5 flex justify-between text-sm">
          <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
            <svg class="h-6 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 455.005 455.005"
...
<!--https://codepen.io/componentity/pen/VwabKLa-->
<script>
export default {
  name: "HorizontalBlogCardBlock19"
}
</script>
