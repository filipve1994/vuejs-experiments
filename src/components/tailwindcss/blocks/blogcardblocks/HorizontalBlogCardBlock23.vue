  ...
  <div class="max-w-screen-2xl mx-auto p-5 sm:p-10 relative">
    ...
    <div class="bg-white">
      <div class="grid grid-cols-12 grid-rows-2 sm:grid-rows-1">
        <div class="col-span-12 sm:col-span-6 relative w-full flex items-end justify-start text-left bg-cover bg-center" style="min-height: 400px; background-image:url(https://media.gettyimages.com/photos/at-the-the-network-tolo-televised-debate-dr-abdullah-abdullah-with-picture-id1179614034?k=6&m=1179614034&s=612x612&w=0&h=WwIX3RMsOQEn5DovD9J3e859CZTdxbHHD3HRyrgU3A8=);">
          ...
          <main class="p-10 z-10">
            <a href="#" class="text-lg tracking-tight font-medium leading-7 font-regular text-white hover:underline">Dr. Abdullah Abdullah's Presidential Election Campaign
            </a>
            <p class="text-white text-sm mt-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.</p>
          </main>
        ...
        <path d="M53.527,192.864c-2.187,3.518-1.109,8.142,2.409,10.329l183.478,114.081c1.232,0.767,2.601,1.132,3.953,1.132
          ...
          <div class="grid grid-cols-2 lg:grid-cols-1 gap-5">
            <div class="lg:border-b pb-4">
              <a href="#"><div class="h-48 bg-cover text-center overflow-hidden" style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
              </div></a>
              <a href="#" class="text-gray-900 text-md font-medium inline-block mt-2 hover:text-indigo-600 transition duration-500 ease-in-out">The perfect summer sweater that you can wear! </a>
            </div>
            <div class="">
              <a href="#"><div class="h-48 bg-cover text-center overflow-hidden" style="background-image: url('https://tailwindcss.com/img/card-left.jpg')" title="Woman holding a mug">
              </div></a>
...
<!--https://codepen.io/componentity/pen/poyPPeJ-->
<script>
export default {
name: "HorizontalBlogCardBlock23"
}
</script>
