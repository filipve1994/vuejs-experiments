    ...
    <div class="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 flex flex-col">
      ...
      <div class="mt-20">
        ...
        <div class="sm:flex items-start">
          <img class="w-48 h-full rounded-sm mr-10" src="https://tailwindcss.com/img/card-left.jpg"
               alt="Avatar of Jonathan Reinink">
          <div class="text-left mt-6">
            <div class="mb-4 text-gray-500">
              <svg height="35px" class="mb-2" fill="#5a67d8" version="1.1" id="Capa_1"
              ...
              <div class="text-sm mt-5">
                <a href="#"
                   class="font-medium leading-none text-gray-900 hover:text-indigo-600 transition duration-500 ease-in-out">Jonathan
                  Reinink</a>
                <p>CEO</p>
              </div>
            </div>
...
<!--https://codepen.io/componentity/pen/rNeMWob-->
<script>
export default {
  name: "TestimonialBlock6"
}
</script>
