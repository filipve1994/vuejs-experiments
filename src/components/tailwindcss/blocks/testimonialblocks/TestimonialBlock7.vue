        ...
        <div class="sm:flex items-center">
          <div class="text-left">
            <div class="mb-4 text-gray-500">
              <svg height="35px" class="mb-2" fill="#5a67d8" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <img class="w-full h-full sm:w-48 sm:h-48 h-full rounded-full sm:ml-10" src="http://codenawis.com/wp-content/uploads/2020/08/images.jpg" alt="Avatar of Jonathan Reinink">
        </div>
...
<!--https://codepen.io/componentity/pen/RwaGoOK-->
<script>
export default {
  name: "TestimonialBlock7"
}
</script>
