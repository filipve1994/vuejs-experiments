    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:space-x-10">
        ...
        <nav class="hidden md:flex space-x-10 ml-auto">
          <a href="#"
             class="text-base leading-6 font-semibold text-indigo-600 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150">
            Home
          </a>
          <a href="#"
              ...
              <div class="rounded-lg shadow-lg">
                <div class="rounded-lg shadow-xs overflow-hidden">
                  <div class="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    <a href="#" class="-m-3 p-3 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150">
                      FA
                    </a>
                    <a href="#" class="-m-3 p-3 rounded-lg hover:bg-gray-50 transition ease-in-out duration-150">
                      EN
          ...
          <div class="py-6 px-5 space-y-6">
            ...
            <div class="space-y-6">
              <p class="text-base leading-6 font-medium text-gray-500">
                ...
                |
                <a href="#" class="text-gray-500 hover:text-indigo-500 transition ease-in-out duration-150">
                  دری
                </a>
              </p>
            </div>
...
<!--https://codepen.io/componentity/pen/mdPrQzx-->
<script>
export default {
  name: "NavbarBlock2"
}
