<template>
  <div class="py-24 max-w-screen-sm mx-auto">
      ...
      <div class="ml-5">
        ...
        <div class="flex items-start my-8">
          ...
          <div class="text-md">
            ...
            <p class="text-gray-500 text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit
              perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</p>
          </div>
        </div>
        <div class="flex items-start my-8">
          <div
...
<!--https://codepen.io/componentity/pen/jOqrpJE-->
<script>
export default {
  name: "FAQBlock1"
}
