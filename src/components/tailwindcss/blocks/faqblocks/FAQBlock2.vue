      ...
      <div class="w-9/12">
        <div class="flex items-start mb-8">
          ...
          <div class="text-md">
            ...
            <p class="text-gray-500 text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis suscipit eaque, iste dolor cupiditate blanditiis ratione.</p>
          </div>
        </div>
        <div class="flex items-start mb-8">
          <div class="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
...
<!--https://codepen.io/componentity/pen/poybONN-->
<script>
export default {
  name: "FAQBlock2"
}
