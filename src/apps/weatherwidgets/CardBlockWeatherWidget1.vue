...
<!--      <p>{{this.weatherData}}</p>-->
      <div class="flex justify-between">
        <div class="flex flex-col">
<!--          <span class="text-6xl font-bold">29°C</span>-->
          <span class="text-6xl font-bold">{{weatherData.main.temp}}°C</span>
          <span class="font-semibold mt-1 text-gray-500">{{weather.city}}, {{weather.country}}</span>
        </div>
<!--        <svg class="h-24 w-24 fill-current text-yellow-400" xmlns="http://www.w3.org/2000/svg" height="24"-->
<!--             viewBox="0 0 24 24" width="24">-->
<!--          <path d="M0 0h24v24H0V0z" fill="none"/>-->
...
<!--              d="M6.76 4.84l-1.8-1.79-1.41 1.41 1.79 1.79zM1 10.5h3v2H1zM11 .55h2V3.5h-2zm8.04 2.495l1.408 1.407-1.79 1.79-1.407-1.408zm-1.8 15.115l1.79 1.8 1.41-1.41-1.8-1.79zM20 10.5h3v2h-3zm-8-5c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4zm-1 4h2v2.95h-2zm-7.45-.96l1.41 1.41 1.79-1.8-1.41-1.41z"/>-->
<!--        </svg>-->
<!--        <i :class="'wi wi-owm-day-' + weatherData.weather[0].id"></i>-->
        <span class="text-yellow-400" style="font-size: 40px;">
        <i :class="'wi wi-owm-day-' + weatherData.weather[0].id"></i>
        </span>
...
<!--https://codepen.io/robstinson/pen/GRjLooj-->
<script>
import axios from "axios";

export default {
  name: "CardBlockWeatherWidget1",
  // components: {
  //   "v-icon": OhVueIcon
  // },
  data() {
    return {
      ...
      apiKey: "bca42c6e974a36a0622e6d298ef5b80e",
      weathericon: '',
    }
  },
  methods: {
    async getWeather() {
      const apiKey = "bca42c6e974a36a0622e6d298ef5b80e";
      const inputVal = "ninove";
      ...
      .then((responseData) => {
        console.log('inside response2 then');
        console.log(JSON.stringify(responseData, null, 2));
        this.weatherData = responseData.data;
        this.displayWeather = true;
        this.weathericon = "http://openweathermap.org/img/w/" + responseData.data.weather[0].icon + ".png";
      })
      .catch((error) => {
        this.weatherData = {};
